...
//     // create a circuits that maps each service to their corresponding circuit
...
//         // circuit service is OPEN here
//         if (circuit.isBlocked()) {
//             // service is unhealthy
//             // calculate  service cooldown
//             Instant unblockedAt = circuit.unBlockedAt(COOLDOWN);
...
//         // Here, circuit service is CLOSED
//         Response response = null;
//         try {
//             response = call();
//         } catch (RuntimeException e) {
//             // timeouts, network calls still count as failures
//             Instant failureTime = Instant.now();
//             circuit.pruneExpiredFailures(failureTime, FAILURE_WINDOW);
//             circuit.recordFailure(failureTime);
//             if (recoveryAttempt || circuit.failureTimes.size() >= FAILURE_THRESHOLD) {
//                 circuit.blockedAt = failureTime;
//             }
//             throw e; // still propagate to caller — breaker observes, doesn't swallow
//         }
...
//             // prune expired failure timestamps
//             circuit.pruneExpiredFailures(failureTime, FAILURE_WINDOW);
...
//         private Instant unBlockedAt(Duration coolDown) {
